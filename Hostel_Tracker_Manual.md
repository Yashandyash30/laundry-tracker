...
If a machine shows up as **🟢 AVAILABLE**, it's all yours!
1. Tap the **Start Machine** button.
2. Fill in your **Name**, **Designation**, and how long your cycle will take (**Duration**). 
3. Create a **PIN**. *Remember this PIN!* It acts as your personal password so nobody else can mess with your timer.
4. Tap **Start**. The machine will turn red (🔴 BUSY) so everyone else knows it's taken.
...
### 4. ⚙️ Finishing Early or Adding Time
Did your clothes wash faster than expected? Or do you need an extra 15 minutes beacuse of powercut or because the machine timer isnt in synchronization with the one in app? 
1. Tap the **⚙️ Finish early / Extend time** dropdown under your active machine.
2. Enter the **PIN** you created when you started the machine.
3. Tap **Finish Early** to instantly free up the machine for the next person, OR tap **Add Time** to extend your timer. 
